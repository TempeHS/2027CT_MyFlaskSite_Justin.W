...
| Sign Up | `/signup` | A sign up page with a form for name, email, password and confromation of password. It validates the email address by making sure @ is included, and the confirmation of password must be equal to the inital passsword. It then redirects user to year form after the criteria is satisfied. It records the name of user using session. |
...
| Subject Page| `/subject` | A subject page with descrptiosn to all subejcts being added into the website. it is managed using the Bootstrap grid system.         |
